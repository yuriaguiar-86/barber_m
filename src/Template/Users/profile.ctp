            ...
            <nav class="primary-navigation nav__view">
                <ul>
                    <li><a href="#" class="header__link">Opções &dtrif;</a>
                        <ul class="dropdown">
                            <li><?= $this->Html->link(__('Trocar senha'), ['controller' => 'Users', 'action' => 'updatePassword'], ['class' => 'header__link']); ?></li>
                            <li><?= $this->Html->link(__('Atualizar'), ['controller' => 'Users', 'action' => 'editProfile'], ['class' => 'header__link']); ?></li>
                        </ul>
                    </li>
                </ul>
            </nav>
